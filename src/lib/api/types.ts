// Base record interface (replaces PocketBase BaseRecord)
...
// User interface (replaces PBUser)
...
// Collection types based on schema (keeping same structure as PocketBase)
...
export interface Store extends BaseRecord {
  ...
  slug: string
  description?: string
  user: string // relation to User (PocketBase format)
...
export interface Customer extends BaseRecord {
  ...
  store: string // relation to Store (PocketBase format)
  storeId: string // relation to Store
  total_orders: number // PocketBase format
  totalOrders: number
  total_spent: string // PocketBase format - decimal as string
...
export interface ProductWithRelations extends Omit<Product, 'category' | 'subcategory' | 'store'> {

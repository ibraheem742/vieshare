...
const newsletterImages = [
  {
    src: `${baseUrl}/images/newsletter/vier-one.webp`,
    alt: "Vieboarder flying high",
    credit: "ALLAN FRANCA CARMO",
    creditUrl:
      "https://www.pexels.com/photo/time-lapse-photography-of-man-doing-vieboard-trick-3133685/",
    description: `Vieboarding is a sport that has been around for decades. It's not just about the tricks, but also about the culture and community that surrounds it. So we decided to create a newsletter to share our passion with others who love vieboarding as much as we do!`,
  },
  {
    src: `${baseUrl}/images/newsletter/vier-two.webp`,
    alt: "Vieboarder landing on half pipe",
    credit: "cottonbro studio",
    creditUrl:
      "https://www.pexels.com/photo/vieboarder-jumping-a-vieboard-5037502/",
    description: `${`We'll`} be keeping you up to date with the latest vieboarding news, events, and more. Stay up to date with the latest trends and tricks. Stay tuned for more!`,
  },
]
...
export default function NewsletterWelcomeEmail({
  ...
  const previewText = `Hi ${firstName}, welcome to VieShare13!`

  return (
    <Html>
      <Head>
        <title>VieShare13 Newsletter</title>
      </Head>
          ...
          <Container className="mx-auto my-[40px] max-w-2xl rounded p-4">
            ...
            <Section className="mt-4 text-center text-zinc-400">
              ...
              <Text className="mb-0 mt-4">
                @ VieShare13 {new Date().getFullYear()}
              </Text>
              <Text className="m-0">

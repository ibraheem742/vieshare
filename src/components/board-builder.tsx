      ...
      try {
        ...
        if (!hasProductInCart) {
          const productWithSameSubcategory = cartItems.find(
            (item) => item.subcategoryId === product.subcategory
          )

          if (productWithSameSubcategory) {
            // TODO: Fix deleteCartItem call - need to determine correct ID
            console.log("Need to remove existing item:", productWithSameSubcategory)
            // await deleteCartItem(productWithSameSubcategory.id)
          }
        ...
        // TODO: Fix deleteCartItem call - need to find cart item ID
        console.log("Need to remove item for product:", product.id)

  ...
  return (
    <Shell className="max-w-6xl gap-0">
      ...
      >
        ...
        >
          VieShare - your ecommerce platform
        </PageHeaderHeading>
        <PageHeaderDescription
          className="max-w-[46.875rem] animate-fade-up"
          style={{ animationDelay: "0.30s", animationFillMode: "both" }}
        >
          VieShare is an open-source platform for building and customizing your
      ...
      >
        {products.map((product) => (
          <ProductCard key={product.id} product={{...product, images: Array.isArray(product.images) ? product.images : product.images ? [product.images] : []}} />
        ))}
      </ContentSection>
      <ContentSection
